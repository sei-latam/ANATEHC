...
#'
#' @examples
extracDATA <- function(user = "SEI", variable = "PRECIPITATION", station.cod = "21010320", 
  ...
  if(user == "SEI"){
    ...
    varlist <- c("PRECIPITATION", "STREAMFLOW")
    
    if(is.element(variable, varlist[ ,2])){
      id.folder <- which(variable, varlist[ ,2])
